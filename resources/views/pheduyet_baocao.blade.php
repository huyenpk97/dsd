...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Phê duyệt báo cáo</li>
    </ol>
  </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-header with-border">
              ...
              <div class="col-md-4">Tiêu đề báo cáo:</div><div class="col-md-8">Báo cáo thường nhật</div>
              <div class="col-md-4">Người thực hiện:</div><div class="col-md-8">Nguyễn Chí Thanh</div>
              <div class="col-md-4">Tên công việc:</div><div class="col-md-8">Tính lương thôi</div>
              <div class="col-md-4">Quy trình</div><div class="col-md-8">Công việc thường xuyên</div>
              <div class="col-md-4">Deadline:</div><div class="col-md-8">Tính lương nhân viênle</div>
              <div class="col-md-4">Tải file báo cáo :</div><div class="col-md-8"><a href="#">Tại đây</a></div>
 <div class="col-md-4">% công việc</div><div class="col-md-8">90%</div>
              <div class="col-md-4">Ghi chú:</div><div class="col-md-8">Tính lương nhân viênl</div>
              <!-- /.box -->
            </div>
          </div>
          <!-- /.box -->
      ...
      <!-- /.row -->
          ...
          <!-- /.col --><div class="col-xs-12">
            ...
            <div class="col-md-4"><button type="button" class="btn btn-block btn-success btn-approval">Phê duyệt</button></div>
            <div class="col-md-4"><button type="button" class="btn btn-block btn-block btn-unapproval">Không duyệt</button></div>
            <div class="col-md-2"></button></div>
          </div>
        </div>
                    <!-- /.col -->
 ...
 <script>
  $(function () {
    ...
    $('.btn-unapproval').on('click', function(e){
      e.preventDefault();
      Swal.fire({
        position: 'center',
        icon: 'error',
        title: 'Báo cáo không được phê duyệt',
        showConfirmButton: true,
        timer: 1500
      }).then((result) => {
        if (result.value) {
