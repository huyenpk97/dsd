...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Chi tiết KPI dự án của nhân viên</li>
    </ol>
  </section>
    ...
    <!-- SELECT2 EXAMPLE -->
     <div class="box box-default">
      <div class="box-header with-border">
         <div class="col-md-4">Mã nhân viên:</div><div class="col-md-8">NV01</div>
              <div class="col-md-4">Tên nhân viên:</div><div class="col-md-8">Nguyễn Chí Thanh</div>
              <div class="col-md-4">Phòng ban:</div><div class="col-md-8">Phòng hành chính nhân sự</div>
              <div class="col-md-4">Dự án:</div><div class="col-md-8">Tăng lương nhân viên</div>
      </div>
