            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('dsKPI_nhanvien')}}"><i class="fa fa-circle-o"></i>DS KPI nhân viên</a></li>
                    <li><a href="{{ route('dsKPI_phongban')}}"><i class="fa fa-circle-o"></i>Ds KPI phòng ban</a></li>
                    <li><a href="{{ route('chitiet_KPIduanNV')}}"><i class="fa fa-circle-o"></i>Chi tiết KPI nhân viên trong dự án</a></li>
                    <li><a href="{{ route('chitiet_KPIduan')}}"><i class="fa fa-circle-o"></i>Chi tiết KPI dự án</a></li>
                    <li><a href="{{ route('chitiet_KPInhanvien')}}"><i class="fa fa-circle-o"></i>Chi tiết KPI nhân viên</a></li>
                    <li><a href="{{ route('chitiet_KPIphongban')}}"><i class="fa fa-circle-o"></i>Chi tiết KPI phòng ban</a></li>
